...
class DatabaseConfig:
    ...
    # Alias to match existing callers
    mongo_db_name: str = os.getenv("MONGO_DB_NAME", "OpenVLACollection")
...
class DatasetConfig:
    ...
    # Active dataset
    active_datasets: List[str] = field(default_factory=lambda: [])
...
class RetrievalConfig:
    ...
    max_results: int = int(os.getenv("DB_LIMIT_NUM", os.getenv("MAX_RESULTS", "100")))
    ...
    # Additional fields used by retrieval_server
    id_field: str = os.getenv("ID_FIELD", "_id")
