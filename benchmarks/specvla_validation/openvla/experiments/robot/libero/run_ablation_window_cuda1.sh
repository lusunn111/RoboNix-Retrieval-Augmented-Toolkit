#!/bin/bash
# 主实验 - 滑动窗口大小消融 (w=3,4,5)
# 
# 在 CUDA 1 上运行，Goal 环境，每个任务 10 次
#
# 使用方法: bash run_ablation_window_cuda1.sh
...
# [1/3] Window Size = 3
echo "============================================================"
echo "[1/3] Window Size = 3"
echo "============================================================"
run_window_experiment 3

# [2/3] Window Size = 4
echo "============================================================"
echo "[2/3] Window Size = 4"
echo "============================================================"
run_window_experiment 4

# [3/3] Window Size = 5
echo "============================================================"
echo "[3/3] Window Size = 5"
echo "============================================================"
run_window_experiment 5

echo ""
echo "=========================================="
echo "滑动窗口消融实验 (w=3,4,5) 运行结束！"
echo "=========================================="
