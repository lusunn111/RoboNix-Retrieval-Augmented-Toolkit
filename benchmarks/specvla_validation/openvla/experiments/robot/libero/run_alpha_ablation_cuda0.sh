#!/bin/bash
# Alpha（融合比例）消融实验 - CUDA 0
# 
# w=5, alpha=0.3, 0.4, 0.5, 0.6, 0.7
# Goal: alpha=0.3, 0.4, 0.5, 0.6, 0.7
# Spatial: alpha=0.3, 0.4, 0.5, 0.6, 0.7
# Long (libero_10): alpha=0.6, 0.7 (threshold=0.4)
#
# 使用方法: bash run_alpha_ablation_cuda0.sh
#
