#!/bin/bash
# Block-wise Speculative Decoding - Spatial 阈值实验 (GPU 0)
# 
# 测试阈值: 0.23, 0.25, 0.27
#
# 使用方法: bash run_libero_block_sd_spatial_cuda0.sh
#
# 前置条件：
...
# =============================================================================
# 运行实验 (阈值: 0.23, 0.25, 0.27)
# =============================================================================
echo "=========================================="
echo "开始运行 Spatial 阈值实验 (GPU 0)"
echo "=========================================="
echo "测试阈值: 0.23, 0.25, 0.27"
echo "=========================================="
echo ""
...
echo "[1/3] 阈值 = 0.23"
echo "============================================================"
run_experiment 0.23 "Spatial_thresh_0.23"

# [2/3] 阈值 0.25
echo "============================================================"
echo "[2/3] 阈值 = 0.25"
echo "============================================================"
run_experiment 0.25 "Spatial_thresh_0.25"

# [3/3] 阈值 0.27
echo "============================================================"
echo "[3/3] 阈值 = 0.27"
echo "============================================================"
run_experiment 0.27 "Spatial_thresh_0.27"
